...
class DekoratorTest {
    ...
    public void start() {
        ...
        this.kuchen = new Dekorator( new Dekorator(new KuchenBoden(HERSTELLER,null, 0
                , null, null, this.einfügeDate, this.aktuellesDate, 0, KuchenTypen.Obstkuchen),"Butter", new BigDecimal("22"), Duration.ofDays(3)
    ...
    public void getAggregatedNameTest() {
        assertEquals("Sahne Butter Kuchen", this.kuchen.getName());
    }
    @Test
    public void getAggregatedNameIsNullTest() {
        this.kuchen = new Dekorator( new Dekorator(new KuchenBoden(HERSTELLER,null, 0
                , null, null, this.einfügeDate, this.aktuellesDate, 0, KuchenTypen.Obstkuchen),null, new BigDecimal("22"), Duration.ofDays(3)
                , new HashSet<>(Arrays.asList(Allergen.Gluten)), 21),"Sahne", new BigDecimal("22")
                , Duration.ofDays(2), new HashSet<>(Arrays.asList(Allergen.Haselnuss)), 21);

        assertEquals("Sahne null Kuchen", this.kuchen.getName());
    }
    @Test
    public void getAggregatedAllergeneErsterTeilTest() {
        assertTrue(this.kuchen.getAllergene().contains(Allergen.Haselnuss));
    }
    @Test
    public void getAggregatedAllergeneZweiterTeilTest() {
    ...
    @Test
    public void getAggregatedEqualHaltbarkeitTest() {
        this.kuchen = new Dekorator( new Dekorator(new KuchenBoden(HERSTELLER,null, 0
                , null, null, this.einfügeDate, this.aktuellesDate, 0, KuchenTypen.Obstkuchen),"Butter", new BigDecimal("22"), Duration.ofDays(2)
                , new HashSet<>(Arrays.asList(Allergen.Gluten)), 21),"Sahne", new BigDecimal("22")
                , Duration.ofDays(2), new HashSet<>(Arrays.asList(Allergen.Haselnuss)), 21);
    ...
    @Test
    public void getAggregatedFirstLowerHaltbarkeitTest() {
        this.kuchen = new Dekorator( new Dekorator(new KuchenBoden(HERSTELLER,null, 0
                , null, null, this.einfügeDate, this.aktuellesDate, 0, KuchenTypen.Obstkuchen),"Butter", new BigDecimal("22"), Duration.ofDays(2)
                , new HashSet<>(Arrays.asList(Allergen.Gluten)), 21),"Sahne", new BigDecimal("22")
                , Duration.ofDays(3), new HashSet<>(Arrays.asList(Allergen.Haselnuss)), 21);
