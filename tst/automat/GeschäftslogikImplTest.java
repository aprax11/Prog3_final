...
public class GeschäftslogikImplTest {
    ...
    public void start() {
        ...
        this.PREIS = new BigDecimal("12.2");
    ...
    @Test
    public void addBelagNoBodenTest()  {
        assertFalse(this.gl.addKuchen(new ArrayList<>(), null));
    }
    @Test
    public void addBodenNoListTest()  {
        this.gl.addHersteller(HERSTELLER);
        assertFalse(this.gl.addKuchen(null,  new Container(HERSTELLER, allergens, NÄHRWERT, DURATION, PREIS, "", KuchenTypen.Obsttorte)));
    }
    ...
    public void getFullTest(){
        assertFalse(this.gl.isFull());
    }

    @Test
    public void getFullBorderTest() {
        if(this.gl.addHersteller(HERSTELLER)) {
            this.gl.addKuchen(new ArrayList<>(), new Container(HERSTELLER, allergens, NÄHRWERT, DURATION, PREIS, "", KuchenTypen.Obstkuchen));
            this.gl.addKuchen(new ArrayList<>(), new Container(HERSTELLER, allergens, NÄHRWERT, DURATION, PREIS, "", KuchenTypen.Obstkuchen));
        }
    ...
    @Test
    public void getFullGoodTest() {
        if(this.gl.addHersteller(HERSTELLER)) {
            this.gl.addKuchen(new ArrayList<>(), new Container(HERSTELLER, allergens, NÄHRWERT, DURATION, PREIS, "", KuchenTypen.Obstkuchen));
            this.gl.addKuchen(new ArrayList<>(), new Container(HERSTELLER, allergens, NÄHRWERT, DURATION, PREIS, "", KuchenTypen.Obstkuchen));
            this.gl.addKuchen(new ArrayList<>(), new Container(HERSTELLER, allergens, NÄHRWERT, DURATION, PREIS, "", KuchenTypen.Obstkuchen));
        }
        assertTrue(this.gl.isFull());
    }
}
