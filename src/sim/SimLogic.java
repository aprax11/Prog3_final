...
public class SimLogic {
    ...
    public synchronized void addRandomKuchen() {
        ...
        switch(kuchenTyp) {
            case 0:
                Container boden = new Container(h, this.allergens, nährwert, duration, preis, "Obstkuchen", KuchenTypen.Obstkuchen);
                this.gl.addKuchen(new ArrayList<>(), boden);
                break;
            case 1:
                Container boden2 = new Container(h, this.allergens, nährwert, duration, preis, "Obsttorte", KuchenTypen.Obsttorte);
                this.gl.addKuchen(new ArrayList<>(), boden2);
                break;
            case 2:
                Container boden3 = new Container(h, this.allergens, nährwert, duration, preis, "Kremkuchen", KuchenTypen.Kremkuchen);
    ...
    private synchronized GanzerKuchen getOldest(GanzerKuchen[] list) {
        if(list.length != 0) {
