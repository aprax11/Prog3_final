...
class KuchenBodenTest {
    ...
    public void start() {
        ...
        this.KUCHENBODEN = new KuchenBoden(HERSTELLER,ALLERGENS, 23
                , Duration.ofDays(2), new BigDecimal("22"), this.einfügeDate, this.aktuellesDate, 12, KuchenTypen.Obstkuchen);
    }
    ...
    @Test
    public void getNameTest() { assertEquals("Kuchen", KUCHENBODEN.getName()); }
    @Test
