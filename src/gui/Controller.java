...
public class Controller {
    ...
    public void updateKuchenList(String type) {
        ...
        for(GanzerKuchen a : this.lsit) {
            ShowKuchen obj = new ShowKuchen(a.getHersteller().getName()
                    , DurationRechner.getVerbleibendeHaltbarkeit(a.getEinfügeDate(), new Date(), a.getHaltbarkeit()).toDays(), a.getFachnummer(), a.getInspektionsdatum());
            showlist[count] = obj;
            count++;
        }
